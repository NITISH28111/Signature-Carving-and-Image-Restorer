...
parser.add_argument('--dataset', default='GoPro', type=str, help='Test Dataset')  # Can be custom dataset too
...
test_loader = DataLoader(dataset=test_dataset, batch_size=1, shuffle=False, num_workers=2, drop_last=False, pin_memory=True)
